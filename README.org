* Go Task Scheduler
[[https://travis-ci.org/altafino/scheduler][https://img.shields.io/travis/altafino/scheduler/master.svg?style=flat-square]] [[http://codecov.io/github/altafino/scheduler?branch=master][http://codecov.io/github/altafino/scheduler/coverage.svg?branch=master]] [[https://godoc.org/github.com/altafino/scheduler][https://img.shields.io/badge/godoc-reference-blue.svg?style=flat-square]] [[https://github.com/altafino/scheduler/blob/master/LICENSE.txt][https://img.shields.io/badge/License-MIT-orange.svg?style=flat-square]]
...
* Installation
#+BEGIN_SRC shell
go get github.com/altafino/scheduler
#+END_SRC
...
The [[https://github.com/altafino/scheduler/tree/master/_example/][Examples]] folder contains a bunch of code samples you can look into.
